...
# TODO: get fom
# "Lebensbedingungen"
# fom_life = (bruttos_normal - houses_normal - foods_normal) (len=32)
fom_life_de = (bruttos_normal['Deutschland'] - houses_normal['Deutschland'] - foods_normal['Deutschland'])
fom_life_ir = (bruttos_normal['Irland'] - houses_normal['Irland'] - foods_normal['Irland'])
fom_life_tr = (bruttos_normal['Türkei'] - houses_normal['Türkei'] - foods_normal['Türkei'])
# "Gesundheit"
# fom_health = (doctors_normal + beds_normal - deaths_normal) (len=31)
fom_health_de = (doctors_normal['Deutschland'] + beds_normal['Deutschland'] - deaths_normal['Deutschland'])
fom_health_ir = (doctors_normal['Irland'] + beds_normal['Irland'] - deaths_normal['Irland'])
fom_health_tr = (doctors_normal['Türkei'] + beds_normal['Türkei'] - deaths_normal['Türkei'])
# TODO: get_plot()

plt.figure(figsize=plt.figaspect(0.4))
plt.subplot(1, 2, 1)
plt.plot(life3_val_int, fom_life_de, color='red')
plt.plot(life3_val_int, fom_life_ir, color='green')
plt.plot(life3_val_int, fom_life_tr, color='blue')
plt.xlabel("Years")
...
plt.subplot(1, 2, 2)
plt.plot(health3_val_int, fom_health_de, color='red')
plt.plot(health3_val_int, fom_health_ir, color='green')
plt.plot(health3_val_int, fom_health_tr, color='blue')
plt.xlabel("Years")
plt.ylabel("Figure of merit [a.u.]")
plt.legend(['Germany', 'Ireland', 'Turkey'])
plt.title('Health')
